...
Cnoise = drtoolbox.techniques.dpca_getNoiseCovariance(Xfull, Xtrial, numOfTrials, ...
...
[~, Vfull, ~] = drtoolbox.techniques.dpca(Xfull, numCompsToUse, ...
...
for rep = 1:options.numRep
    ...
    [W,V,whichMarg] = drtoolbox.techniques.dpca(Xtrain, numCompsToUse, ...
         'combinedParams', options.combinedParams, ...
         'lambda', options.lambda, ...
         'timeSplits', options.timeSplits, ...
         'timeParameter', options.timeParameter, ...
