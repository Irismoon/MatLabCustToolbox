...
% or a list of numbers for each marginalization). whichMarg is an array of
...
% marginalize
[Xmargs, margNums] = drtoolbox.techniques.dpca_marginalize(XfullCen, 'combinedParams', options.combinedParams, ...
