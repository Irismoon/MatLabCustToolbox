...
%explorer C:|tmpt, 
%explorer peaks, 
% explorer£¬open the current folder
% explorer(directory)£¬open a specified folder
% explorer peaks,open the folder containing peaks.m
%explorer peaks 1, also show the folder hierarchy inside that folder
